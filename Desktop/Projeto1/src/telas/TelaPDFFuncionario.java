 ...
 * @author mateus
 */
public class TelaPDFFuncionario extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaPDF
     */
    public TelaPDFFuncionario() {
        initComponents();
    }

   ControlaFuncionario cc = new ControlaFuncionario();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (caminho.isEmpty()) {
            ...
            try {
                ...
                int[] larguras = {4, 16, 25};

                PDFManager.gerar(cc.recuperarTodos(), caminho, ordem, larguras, rotulos);
                JOptionPane.showMessageDialog(null, "PDF gerado com sucesso com o nome Funcionario.pdf");
