 ...
 * @author mateus
 */
public class TelaPDFProduto extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaPDF
     */
    public TelaPDFProduto() {
        initComponents();
    }

   ControlaProduto cc = new ControlaProduto();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (caminho.isEmpty()) {
            ...
            try {
                String[] ordem = {
                    "id", "nome", "tipo", "peso", "ingrediente", "qtdestoque"
                };
                String[] rotulos = {
                    "ID", "Nome", "Tipo", "Peso", "Ingrediente", "QtdEstoque"
                };

                int[] larguras = {4, 16, 11, 14, 18, 22};

                PDFManager.gerar(cc.recuperarTodos(), caminho, ordem, larguras, rotulos);
                JOptionPane.showMessageDialog(null, "PDF gerado com sucesso com o nome Produto.pdf");
